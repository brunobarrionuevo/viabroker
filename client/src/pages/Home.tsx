...
const PlanCard = memo(({ plan, index }: { 
  plan: { name: string; price: string; period: string; description: string; features: string[]; highlight: boolean };
  index: number;
}) => (
  <Card 
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <nav className="container mx-auto px-4 py-4 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-2 pt-2 border-t">
                {isAuthenticated ? (
                  ...
                  <>
                    <Button variant="outline" asChild className="w-full touch-manipulation">
                      <Link href="/login">Entrar</Link>
                    </Button>
                    <Button asChild className="w-full touch-manipulation">
                      <Link href="/cadastro">Começar Grátis</Link>
      ...
      {/* CTA Section */}
      <section id="contact" className="py-16 lg:py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">
            Pronto para revolucionar seu negócio?
          </h2>
          <p className="text-base lg:text-lg opacity-90 mb-8 max-w-2xl mx-auto">
      ...
      {/* Footer */}
      <footer className="py-8 lg:py-12 border-t">
        <div className="container mx-auto px-4">
