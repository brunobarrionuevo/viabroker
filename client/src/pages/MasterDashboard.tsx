          ...
          <TabsContent value="settings">
            <Card className="bg-white border-gray-200 shadow-sm">
              ...
              <CardContent className="space-y-6">
                ...
                {/* Configurações de IA - Em breve */}
                <div className="border rounded-lg p-4 bg-gray-50">
                  <h3 className="font-semibold text-gray-900 mb-4">Configurações de IA</h3>
                  <p className="text-sm text-gray-600">
                    A geração de descrições com IA está configurada com prompts otimizados para o mercado imobiliário brasileiro.
                    Modelo: <strong>gpt-4o-mini</strong> (OpenAI)
                  </p>
                  <p className="text-xs text-gray-500 mt-2">
                    Para personalizar os prompts, entre em contato com o suporte técnico.
                  </p>
                </div>
              </CardContent>
            </Card>
